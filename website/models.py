...
class Usuario(UserMixin, db.Model):
    ...
    cupon_abono_mes = db.Column(db.String(7))
    cupon_abono_actividad = db.Column(db.String(20))
    cupon_abono_dia_semana = db.Column(db.Integer)
    cupon_abono_hora_inicio = db.Column(db.Integer)
    cupon_abono_porcentaje = db.Column(db.Float, nullable=False, default=0.0)
